...
public:
   ...
   */
  QoSEvent(rclpy_debug::Subscription & subscriber, rcl_subscription_event_type_t event_type);
   ...
   * \param[in] event_type Type of event to create
   */
  QoSEvent(rclpy_debug::Publisher & publisher, rcl_publisher_event_type_t event_type);
   ...
   *
   * \return Event data as an instance of a suitable rclpy_debug.qos_event type, or None
...
/// Define a pybind11 wrapper for an rclpy_debug::QoSEvent
/**

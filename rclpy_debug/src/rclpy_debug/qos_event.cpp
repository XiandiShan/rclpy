...
QoSEvent::QoSEvent(
  rclpy_debug::Subscription & subscription, rcl_subscription_event_type_t event_type)
...
QoSEvent::QoSEvent(
  rclpy_debug::Publisher & publisher, rcl_publisher_event_type_t event_type)
...
define_qos_event(py::module module)
{
  ...
  .def(py::init<rclpy_debug::Subscription &, rcl_subscription_event_type_t>())
  .def(py::init<rclpy_debug::Publisher &, rcl_publisher_event_type_t>())

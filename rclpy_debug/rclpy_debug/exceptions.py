...
class NotInitializedException(Exception):
    """Raised when the rclpy_debug implementation is accessed before rclpy_debug.init()."""

    def __init__(self, *args):
        Exception.__init__(self, 'rclpy_debug.init() has not been called', *args)
...
class ROSInterruptException(Exception):
    """Raised when an operation is canceled by rclpy_debug shutting down."""

    def __init__(self, *args):
        Exception.__init__(self, 'rclpy_debug.shutdown() has been called', *args)

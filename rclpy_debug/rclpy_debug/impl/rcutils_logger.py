...
_internal_callers = []
# This will cause rclpy_debug filenames to be registered in `_internal_callers` on first logging call.
_populate_internal_callers = True


def _find_caller(frame):
    """Get the first calling frame that is outside of rclpy_debug."""
    ...
    if _populate_internal_callers:
        ...
        _internal_callers.extend([
            ...
            os.path.realpath(rclpy_debug.logging.__file__),
        ])

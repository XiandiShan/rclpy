...
from rclpy_debug.clock import ClockChange
...
from rclpy_debug.time_source import CLOCK_TOPIC
...
class TestTimeSource(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.node = rclpy_debug.create_node(
            'TestTimeSource', namespace='/rclpy_debug', context=self.context,
    ...
    def publish_clock_messages(self):
        ...
        while rclpy_debug.ok(context=self.context) and cycle_count < 5:
            ...
            rclpy_debug.spin_once(self.node, timeout_sec=1, executor=executor)
    ...
    def test_time_source_using_sim_time(self):
        ...
        node2 = rclpy_debug.create_node('TestTimeSource2', namespace='/rclpy_debug', context=self.context)

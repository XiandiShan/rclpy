...
class TestCreateNode(unittest.TestCase):
    ...
    def test_create_node(self):
        ...
        rclpy_debug.create_node(node_name, context=self.context).destroy_node()

    def test_create_node_with_namespace(self):
        node_name = 'create_node_test'
        namespace = '/ns'
        rclpy_debug.create_node(node_name, namespace=namespace, context=self.context).destroy_node()

    def test_create_node_with_empty_namespace(self):
        node_name = 'create_node_test'
        namespace = ''
        node = rclpy_debug.create_node(node_name, namespace=namespace, context=self.context)
    ...
    def test_create_node_invalid_name(self):
        ...
        with self.assertRaisesRegex(InvalidNodeNameException, 'must not contain characters'):
            rclpy_debug.create_node(node_name, context=self.context)
    ...
    def test_create_node_invalid_relative_namespace(self):
        ...
        with self.assertRaisesRegex(InvalidNamespaceException, 'must not contain characters'):
            rclpy_debug.create_node(node_name, namespace=namespace, context=self.context)

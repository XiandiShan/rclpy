...
TEST(test_allocator, vector) {
  ...
  std::vector<int, rclpy_debug::PythonAllocator<int>> container(42);
...
TEST(test_allocator, equality) {
  ...
  rclpy_debug::PythonAllocator<int> int_alloc;
  rclpy_debug::PythonAllocator<float> float_alloc;
...
TEST(test_allocator, copy_construct_make_1) {
  ...
  rclpy_debug::PythonAllocator<float> float_alloc;
  rclpy_debug::PythonAllocator<int> int_alloc(float_alloc);

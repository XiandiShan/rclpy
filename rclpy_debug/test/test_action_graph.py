...
class TestActionGraph(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.node0 = rclpy_debug.create_node(TEST_NODE0, namespace=TEST_NAMESPACE0, context=cls.context)
        cls.node1 = rclpy_debug.create_node(TEST_NODE1, namespace=TEST_NAMESPACE1, context=cls.context)
        cls.node2 = rclpy_debug.create_node(TEST_NODE2, namespace=TEST_NAMESPACE2, context=cls.context)

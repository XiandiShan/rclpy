...
class TestParameterService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_node = rclpy_debug.create_node(
            'test_parameter_service',
            namespace='/rclpy_debug',
            context=self.context)

        self.get_parameter_client = self.test_node.create_client(
            GetParameters, '/rclpy_debug/test_parameter_service/get_parameters',
            qos_profile=qos_profile_services_default
        )

        self.describe_parameters_client = self.test_node.create_client(
            DescribeParameters, '/rclpy_debug/test_parameter_service/describe_parameters',
            qos_profile=qos_profile_services_default
        )

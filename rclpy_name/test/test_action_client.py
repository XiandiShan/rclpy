...
class TestActionClient(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.node = rclpy_debug.create_node('TestActionClient', context=cls.context)
    ...
    def test_constructor_no_defaults(self):
        ac = ActionClient(
            ...
            feedback_sub_qos_profile=rclpy_debug.qos.QoSProfile(depth=10),
            status_sub_qos_profile=rclpy_debug.qos.QoSProfile(depth=10)
        )
        ac.destroy()
    ...
    def test_send_goal_async_with_feedback_after_goal_result_requested(self):
        ...
        try:
            ...
            rclpy_debug.spin_until_future_complete(self.node, result_future, self.executor)
    ...
    def test_send_goal_multiple(self):
        ...
        try:
            ...
            rclpy_debug.spin_until_future_complete(self.node, future_0, executor)
            rclpy_debug.spin_until_future_complete(self.node, future_1, executor)
            rclpy_debug.spin_until_future_complete(self.node, future_2, executor)

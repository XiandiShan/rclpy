...
public:
   ...
   *
   * \param[in] pyparameter_cls The rclpy_debug.parameter.Parameter class object.
   * \return A dict mapping parameter names to rclpy_debug.parameter.Parameter (may be empty).
   */
  py::dict

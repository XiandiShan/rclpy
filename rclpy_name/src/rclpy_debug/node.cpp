  ...
  RCPPUTILS_SCOPE_EXIT(
    {
      ...
      if (RCUTILS_RET_OK != fini_ret) {
        ...
        PyErr_WarnFormat(
          ...
          "[rclpy_debug| %s : %s ]: failed to fini node names during error handling: %s",
      ...
      if (RCUTILS_RET_OK != fini_ret) {
        ...
        PyErr_WarnFormat(
          PyExc_RuntimeWarning, stack_level,
          "[rclpy_debug| %s : %s ]: failed to fini node namespaces during error handling: %s",
          RCUTILS_STRINGIFY(__FILE__), RCUTILS_STRINGIFY(__LINE__), rcl_get_error_string().str);
        rcl_reset_error();
      }
      ...
      if (RCUTILS_RET_OK != fini_ret) {
        ...
        PyErr_WarnFormat(
          PyExc_RuntimeWarning, stack_level,
          "[rclpy_debug| %s : %s ]: failed to fini enclaves string array during error handling: %s",
          RCUTILS_STRINGIFY(__FILE__), RCUTILS_STRINGIFY(__LINE__), rcl_get_error_string().str);
        rcl_reset_error();
      }
    });
...
/// Create an rclpy_debug.parameter.Parameter from an rcl_variant_t
/**
...
: context_(context)
{
  ...
  *rcl_node_ = rcl_get_zero_initialized_node();
  ...
  {
    rclpy_debug::LoggingGuard scoped_logging_guard;
    ret = rcl_node_init(
  ...
  const char * remote_node_name, const char * remote_node_namespace)
{
  ...
  rcl_ret_t ret = rcl_action_get_client_names_and_types_by_node(
    ...
    &names_and_types);
  if (RCL_RET_OK != ret) {
    throw rclpy_debug::RCLError("Failed to get action client names and type");
  }
  ...
  const char * remote_node_name, const char * remote_node_namespace)
{
  ...
  rcl_ret_t ret = rcl_action_get_server_names_and_types_by_node(
    ...
    &names_and_types);
  if (RCL_RET_OK != ret) {
    throw rclpy_debug::RCLError("Failed to get action server names and type");
  }
...
Node::get_action_names_and_types()
{
  ...
  if (RCL_RET_OK != ret) {
    throw rclpy_debug::RCLError("Failed to get action names and type");
  }

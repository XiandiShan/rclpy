...
// Fill a given rmw_time_t from an rclpy_debug.duration.Duration instance.
void
 ...
 *
 * \param[in] qos_history an rclpy_debug.qos.QoSHistoryPolicy value.
 * \param[in] qos_depth depth of the message queue.
 * \param[in] qos_reliability an rclpy_debug.qos.QoSReliabilityPolicy value.
 * \param[in] qos_durability an rclpy_debug.qos.QoSDurabilityPolicy value.
 * \param[in] pyqos_lifespan lifespan QoS policy parameter of
 *   rcl_duration_t type.
 * \param[in] pyqos_deadline deadline QoS policy parameter of
 *   rcl_duration_t type.
 * \param[in] qos_liveliness an rclpy_debug.qos.QoSLivelinessPolicy value.

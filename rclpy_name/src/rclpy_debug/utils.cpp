...
void
assert_liveliness(rclpy_debug::Publisher * publisher)
{
  ...
  RCPPUTILS_SCOPE_EXIT(
    {
      ...
      if (RCL_RET_OK != ret) {
        RCUTILS_SAFE_FWRITE_TO_STDERR(
          "[rclpy_debug|" RCUTILS_STRINGIFY(__FILE__) ":" RCUTILS_STRINGIFY(__LINE__) "]: "
 ...
 * See: https://github.com/ros2/rclpy_debug/pull/180#issuecomment-375452757
 */
#if defined(_MSC_VER)
#pragma warning(push)
...
{
  auto pyduration_module = py::module::import("rclpy_debug.duration");

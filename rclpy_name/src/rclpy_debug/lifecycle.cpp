...
namespace
{
class LifecycleStateMachine : public rclpy_debug::Destroyable,
  public std::enable_shared_from_this<LifecycleStateMachine>
{
public:
  LifecycleStateMachine(
    rclpy_debug::Node & node, bool enable_com_interface)
  : node_(node)
  {
    ...
    if (RCL_RET_OK != ret) {
      throw rclpy_debug::RCLError("Failed to create lifecycle state machine");
    }
    if (state_machine_->options.enable_com_interface) {
      srv_change_state_ = std::make_shared<rclpy_debug::Service>(
        node_,
        std::shared_ptr<rcl_service_t>(
          state_machine_, &state_machine_->com_interface.srv_change_state));
      srv_get_state_ = std::make_shared<rclpy_debug::Service>(
        node_,
        std::shared_ptr<rcl_service_t>(
          state_machine_, &state_machine_->com_interface.srv_get_state));
      srv_get_available_states_ = std::make_shared<rclpy_debug::Service>(
        node_,
        std::shared_ptr<rcl_service_t>(
          state_machine_, &state_machine_->com_interface.srv_get_available_states));
      srv_get_available_transitions_ = std::make_shared<rclpy_debug::Service>(
        node_,
        std::shared_ptr<rcl_service_t>(
          state_machine_, &state_machine_->com_interface.srv_get_available_transitions));
      srv_get_transition_graph_ = std::make_shared<rclpy_debug::Service>(
        node_,
        std::shared_ptr<rcl_service_t>(
  ...
  trigger_transition_by_id(uint8_t transition_id, bool publish_update)
  {
    ...
    {
      throw rclpy_debug::RCLError("Failed to trigger lifecycle state machine transition");
    }
  }
  ...
  get_transition_by_label(std::string label)
  {
    ...
    if (nullptr == transition) {
      throw rclpy_debug::RCLError("Failed to get transition from label");
    }
  ...
  std::shared_ptr<rclpy_debug::Service>
...
private:
  rclpy_debug::Node node_;
  std::shared_ptr<rclpy_debug::Service> srv_change_state_;
  std::shared_ptr<rclpy_debug::Service> srv_get_state_;
  std::shared_ptr<rclpy_debug::Service> srv_get_available_states_;
  std::shared_ptr<rclpy_debug::Service> srv_get_available_transitions_;
  std::shared_ptr<rclpy_debug::Service> srv_get_transition_graph_;

...
latex_documents = [
    (master_doc, 'rclpy_debug.tex', 'rclpy_debug Documentation',
...
man_pages = [
    (master_doc, 'rclpy_debug', 'rclpy_debug Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rclpy_debug', 'rclpy_debug Documentation',
     author, 'rclpy_debug', 'One line description of project.',
     'Miscellaneous'),
]
